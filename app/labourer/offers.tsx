        ...
        ListHeaderComponent={
          <View>
            ...
            <View style={styles.segment}>
              <FilterButton label="Pending" active={selectedStatus === "pending"} onPress={() => setSelectedStatus("pending")} />
              <FilterButton label="Signed" active={selectedStatus === "approved"} onPress={() => setSelectedStatus("approved")} />
              <FilterButton label="Declined" active={selectedStatus === "declined"} onPress={() => setSelectedStatus("declined")} />
            </View>
              ...
              >
                ...
                {selectedOffer.status === "pending" ? (
                  <View style={{ marginTop: spacing.md, gap: spacing.md }}>
                    <View style={{ gap: 6 }}>
                      <Text style={styles.fieldLabel}>Signature (type your full name)</Text>
                      <TextInput
                        value={signature}
                    ...
                    <View style={{ flexDirection: "row", gap: spacing.md }}>
                      <View style={{ flex: 1 }}>
                        <Button label={submitting ? "Submitting..." : "Decline"} variant="secondary" onPress={() => respond("declined")} disabled={submitting} />
                      </View>
                      <View style={{ flex: 1 }}>
                        <Button label={submitting ? "Submitting..." : "Sign & Approve"} onPress={() => respond("approved")} disabled={submitting} />
                      </View>
                    </View>
                  </View>
                ) : (
